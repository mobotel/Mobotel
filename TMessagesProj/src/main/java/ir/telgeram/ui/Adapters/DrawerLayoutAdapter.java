...
//                holder.itemView.setBackgroundColor(Theme.getColor(Theme.key_avatar_backgroundActionBarBlue)); // Adel Commented
                break;
            case 3:
    ...
    private void resetItems() {
        ...
        items.add(null); // divider 5
        items.add(new Item(6, LocaleController.getString("Contacts", R.string.Contacts), R.drawable.menu_contacts));
        items.add(new Item(16, LocaleController.getString("OnlineContacts", R.string.OnlineContacts), R.drawable.ic_contacts_white_24dp));
        ...
        items.add(new Item(18, LocaleController.getString("MySettings", R.string.MySettings), R.drawable.ic_settings_applications_white_24dp));
//        items.add(null); // divider 11
        ...
        items.add(new Item(21, LocaleController.getString("MarkAsRead", R.string.MarkAsRead), R.drawable.ic_remove_red_eye_white_24dp));
        items.add(new Item(17, LocaleController.getString("UsernameFinder", R.string.UsernameFinder), R.drawable.menu_contacts));
        items.add(new Item(20, LocaleController.getString("CacheCleaner", R.string.CacheCleaner), R.drawable.chats_clear));
        items.add(new Item(12, LocaleController.getString("ReportElimination", R.string.ReportElimination), R.drawable.menu_contacts));
        items.add(new Item(13, LocaleController.getString("TelgeramChannel", R.string.TelgeramChannel), R.drawable.menu_broadcast));
	    items.add(new Item(9, LocaleController.getString("TelegramFaq", R.string.TelegramFaq), R.drawable.menu_help));
        items.add(new Item(19, LocaleController.getString("AboutUs", R.string.AboutUs), R.drawable.profile_info));
    }
