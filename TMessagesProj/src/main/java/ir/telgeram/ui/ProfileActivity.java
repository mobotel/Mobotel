...
import ir.telgeram.messenger.query.SharedMediaQuery;
...
import ir.telgeram.ui.Cells.AboutLinkCell;
...
import ir.telgeram.ui.Cells.TextDetailCell;
...
import ir.telgeram.ui.Components.IdenticonDrawable;
...
//        actionBar.setItemsBackgroundColor(AvatarDrawable.getButtonColorForId(user_id != 0 || ChatObject.isChannel(chat_id) && !currentChat.megagroup ? 5 : chat_id), false); // Adel Commented
...
//        topView.setBackgroundColor(AvatarDrawable.getProfileBackColorForId(user_id != 0 || ChatObject.isChannel(chat_id) && !currentChat.megagroup ? 5 : chat_id)); // Adel Commented
        ...
        for (int a = 0; a < 2; a++) {
            ...
            onlineTextView[a].setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // Adel
    ...
    public void setAnimationProgress(float progress) {
        ...
        int actionBarColor = ThemeChanger.getcurrent().getActionbarcolor(); // Adel
        ...
        int aD;
//        topView.setBackgroundColor(Color.rgb(r + rD, g + gD, b + bD)); // Adel Commented
        topView.setBackgroundColor(ThemeChanger.getcurrent().getActionbarcolor()); // Adel
