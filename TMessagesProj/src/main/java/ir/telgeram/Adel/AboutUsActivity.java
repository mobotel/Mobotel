...
public class AboutUsActivity extends BaseFragment
{
	...
	public View createView(Context context)
	{
		...
		txtappversion.setText(LocaleController.getString("Version", R.string.Version) + ": " + versionName);
		...
		img.setImageDrawable(context.getResources().getDrawable(R.drawable.mehdi_logo));
	...
	private class AboutListAdapter extends BaseAdapter
	{
		...
		public View getView(int i, View view, ViewGroup viewGroup)
		{
			...
			if (i == 0)
			{
				txt.setText("صاحب امتیاز پروژه: سید مهدی موسوی");
			}
			else if (i == 1)
			{
				txt.setText(LocaleController.getString("ContactUs", R.string.ContactUs) + ": " + "info@tosedahandegan.ir");
			}
			else if (i == 2)
			{
				txt.setText(LocaleController.getString("ProgrammedBy", R.string.ProgrammedBy) + " " + "عادل خنجری صادق");
			}
