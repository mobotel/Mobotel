...
actionBar.setTitle(LocaleController.getString("MySettings",R.string.MySettings));
    ...
    private class ListAdapter extends BaseFragmentAdapter {
        ...
        public boolean isEnabled(int i) {
            return i==DefaultFont||i==DefaultTab ||i==TabisUpside||i==ghostactivate||i==ProTelegram||i==sendtyping||i==sendDeliver||i==favor||i==bot||i==all||i==channel||i==contact||i==ngroup||i==sgroup||i==unread ;
        }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                if (i == DefaultTab) {
                    textCell.setTextAndValue(LocaleController.getString("DefaultTab", R.string.DefaultTab), LocaleController.getString("TabTitle", TabSetting.getTabModels().get(Setting.GetCurrentTab()).getTitle()), true);
                ...
                }else if (i == favor){textCell.setTextAndCheck(LocaleController.getString("Favorites", R.string.Favorites), Setting.TabisShowed("favor"),true);
                }else if (i == all){textCell.setTextAndCheck(LocaleController.getString("AllChats", R.string.AllChats), Setting.TabisShowed("all"),true);
                }else if (i == channel){textCell.setTextAndCheck(LocaleController.getString("Channels", R.string.Channels), Setting.TabisShowed("channel"),true);
                }else if (i == sgroup){textCell.setTextAndCheck(LocaleController.getString("SuperGroups", R.string.SuperGroups),  Setting.TabisShowed("sgroup"),true);
                }else if (i == ngroup){textCell.setTextAndCheck(LocaleController.getString("Groups", R.string.Groups), Setting.TabisShowed("ngroup"),true);
                }else if (i == bot){textCell.setTextAndCheck(LocaleController.getString("Bot", R.string.Bot),  Setting.TabisShowed("bot"),true);
                }else if (i == contact){textCell.setTextAndCheck(LocaleController.getString("Contacts", R.string.Contacts), Setting.TabisShowed("contact"),true);
                }else if (i == unread){textCell.setTextAndCheck(LocaleController.getString("Unread", R.string.Unread), Setting.TabisShowed("unread"),true);
                }
            } else if (type == 4) {
                if (view == null) {
        ...
        public int getItemViewType(int i) {
            if (i==newgeramsectionrow||Graphicsectionrow==i||tabsectionrow==i ) {
                return 1;
            } else if (TabisUpside==i||sendDeliver==i ||ghostactivate==i||i==sendtyping||favor==i||bot==i||all==i||contact==i||sgroup==i||ngroup==i||unread==i||channel==i) {
                return 3;
