...
public class Setting
{
	...
	private static void setupSetting()
	{
		if (pref == null)
		{
			pref = ApplicationLoader.applicationContext.getSharedPreferences(PREF_NAME, PRIVATE_MODE);
			editor = pref.edit();
		}
	}
	...
	{
		setupSetting();
		return pref.getInt("actionbarcolor", Color.parseColor("#527da3"));
	}
	...
	{
		setupSetting();
		return pref.getInt("tabcolor", Color.parseColor("#527da3"));
	}
	...
	{
		setupSetting();
		return pref.getString("currentfont", "IRANSansUltraLight");
	}
