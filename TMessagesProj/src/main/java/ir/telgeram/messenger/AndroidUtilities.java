...
public class AndroidUtilities {
    ...
    private static Typeface adelTypeface = null;
    ...
    public static Typeface getTypeface(String assetPath) {
        synchronized (typefaceCache) {
            // Adel
            if (true || LocaleController.getInstance().getCurrentLanguageName().equals("فارسی")) {
                if (adelTypeface == null) {
                    adelTypeface = Typeface.createFromAsset(ApplicationLoader.applicationContext.getAssets(), "fonts/" + Setting.getCurrentFont() + ".ttf");
                }
                return adelTypeface;
            }
