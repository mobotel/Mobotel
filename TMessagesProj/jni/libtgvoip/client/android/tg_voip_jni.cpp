...
extern "C" JNIEXPORT jlong Java_ir_telgeram_messenger_voip_VoIPController_nativeInit(JNIEnv* env, jobject thiz, jint systemVersion){
	CAudioOutputAndroid::systemVersion=systemVersion;

	env->GetJavaVM(&sharedJVM);
	if(!CAudioInputAndroid::jniClass){
		jclass cls=env->FindClass("ir/telgeram/messenger/voip/AudioRecordJNI");
		...
		cls=env->FindClass("ir/telgeram/messenger/voip/AudioTrackJNI");
...
extern "C" JNIEXPORT void Java_ir_telgeram_messenger_voip_VoIPController_nativeStart(JNIEnv* env, jobject thiz, jlong inst){
	((CVoIPController*)(intptr_t)inst)->Start();
}

extern "C" JNIEXPORT void Java_ir_telgeram_messenger_voip_VoIPController_nativeConnect(JNIEnv* env, jobject thiz, jlong inst){
	((CVoIPController*)(intptr_t)inst)->Connect();
}

extern "C" JNIEXPORT void Java_ir_telgeram_messenger_voip_VoIPController_nativeSetEncryptionKey(JNIEnv* env, jobject thiz, jlong inst, jbyteArray key, jboolean isOutgoing){
...
extern "C" JNIEXPORT void Java_ir_telgeram_messenger_voip_VoIPController_nativeSetRemoteEndpoints(JNIEnv* env, jobject thiz, jlong inst, jobjectArray endpoints, jboolean allowP2p){
...
extern "C" JNIEXPORT void Java_ir_telgeram_messenger_voip_VoIPController_nativeSetNativeBufferSize(JNIEnv* env, jclass thiz, jint size){
	CAudioOutputOpenSLES::nativeBufferSize=size;
	CAudioInputOpenSLES::nativeBufferSize=size;
}

extern "C" JNIEXPORT void Java_ir_telgeram_messenger_voip_VoIPController_nativeRelease(JNIEnv* env, jobject thiz, jlong inst){
...
extern "C" JNIEXPORT void Java_ir_telgeram_messenger_voip_AudioRecordJNI_nativeCallback(JNIEnv* env, jobject thiz, jobject buffer){
...
extern "C" JNIEXPORT void Java_ir_telgeram_messenger_voip_AudioTrackJNI_nativeCallback(JNIEnv* env, jobject thiz, jbyteArray buffer){
...
extern "C" JNIEXPORT jstring Java_ir_telgeram_messenger_voip_VoIPController_nativeGetDebugString(JNIEnv* env, jobject thiz, jlong inst){
	char buf[10240];
	((CVoIPController*)(intptr_t)inst)->GetDebugString(buf, 10240);
	return env->NewStringUTF(buf);
}

extern "C" JNIEXPORT void Java_ir_telgeram_messenger_voip_VoIPController_nativeSetNetworkType(JNIEnv* env, jobject thiz, jlong inst, jint type){
	((CVoIPController*)(intptr_t)inst)->SetNetworkType(type);
}

extern "C" JNIEXPORT void Java_ir_telgeram_messenger_voip_VoIPController_nativeSetMicMute(JNIEnv* env, jobject thiz, jlong inst, jboolean mute){
	((CVoIPController*)(intptr_t)inst)->SetMicMute(mute);
}

extern "C" JNIEXPORT void Java_ir_telgeram_messenger_voip_VoIPController_nativeSetConfig(JNIEnv* env, jobject thiz, jlong inst, jdouble recvTimeout, jdouble initTimeout, jint dataSavingMode, jboolean enableAEC, jboolean enableNS, jboolean enableAGC, jstring logFilePath){
	voip_config_t cfg;
...
extern "C" JNIEXPORT void Java_ir_telgeram_messenger_voip_VoIPController_nativeDebugCtl(JNIEnv* env, jobject thiz, jlong inst, jint request, jint param){
	((CVoIPController*)(intptr_t)inst)->DebugCtl(request, param);
}

extern "C" JNIEXPORT jstring Java_ir_telgeram_messenger_voip_VoIPController_nativeGetVersion(JNIEnv* env, jclass clasz){
	return env->NewStringUTF(CVoIPController::GetVersion());
}

extern "C" JNIEXPORT jlong Java_ir_telgeram_messenger_voip_VoIPController_nativeGetPreferredRelayID(JNIEnv* env, jclass clasz, jlong inst){
	return ((CVoIPController*)(intptr_t)inst)->GetPreferredRelayID();
}

extern "C" JNIEXPORT jint Java_ir_telgeram_messenger_voip_VoIPController_nativeGetLastError(JNIEnv* env, jclass clasz, jlong inst){
	return ((CVoIPController*)(intptr_t)inst)->GetLastError();
}

extern "C" JNIEXPORT void Java_ir_telgeram_messenger_voip_VoIPController_nativeGetStats(JNIEnv* env, jclass clasz, jlong inst, jobject stats){
	voip_stats_t _stats;
...
extern "C" JNIEXPORT void Java_ir_telgeram_messenger_voip_VoIPServerConfig_nativeSetConfig(JNIEnv* env, jclass clasz, jobjectArray keys, jobjectArray values){
...
extern "C" JNIEXPORT jstring Java_ir_telgeram_messenger_voip_VoIPController_nativeGetDebugLog(JNIEnv* env, jobject thiz, jlong inst){
	CVoIPController* ctlr=((CVoIPController*)(intptr_t)inst);
